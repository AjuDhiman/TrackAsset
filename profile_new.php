<?php 
    ...
    if(isset($_POST['edit'])){
        ...
        $query = mysql_query("UPDATE `users` SET  `agent_type` = '".$agent_type."', `password` = '".$result['password']."' WHERE `username` = '".$_SESSION['username']."'");
         echo'<script>window.location="profile_new.php";</script>';     
        } 
        else{
        //echo "UPDATE `users` SET  `password` = '".$newpassword."' WHERE `id` = $Id";
        $query = mysql_query("UPDATE `users` SET  `agent_type` = '".$agent_type."', `password` = '".$newpassword."' WHERE `username` = '".$_SESSION['username']."'");
         echo'<script>window.location="profile_new.php";</script>';     
        }   
    }
?>          
        ...
        <!-- BEGIN EXAMPLE TABLE PORTLET-->
                    ...
                    <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption">
                                        <i class="fa fa-edit"></i>Your Profile
                                </div>
                                <div class="tools">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select name="agent_type" class="form-control">
													...
													<option value="3" <?php if ($result['agent_type'] === '3'){echo 'selected="selected"';}?> >Admin</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
